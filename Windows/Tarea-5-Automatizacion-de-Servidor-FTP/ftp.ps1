...
# Cargar módulo para administrar roles
...
# Importar módulo IIS solo si existe
if (Get-Module -ListAvailable -Name WebAdministration) {
    Import-Module WebAdministration
    Write-Host "Módulo WebAdministration cargado correctamente."
}
else {
    Write-Host "Advertencia: WebAdministration aún no está disponible."
}
